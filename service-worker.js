...
const F=['./manifest.webmanifest','./evia-release.json','./evia-approved-features.js','./evia-approved-learning-ui.js','./evia-approved-menu-support.js','./evia-approved-epa.js','./evia-approved-targets.js','./evia-approved-target-plan-v1.js','./evia-approved-updates-stable-v1.js','./evia-approved-runtime-fixes-v1.js','./evia-ui-polish-v1.js','./evia-ui-polish-visible-v1.js','./evia-approved-settings-stable-v1.js','./evia-approved-speech-landing-fix.js','./icons/evia-180.png','./icons/evia-192.png','./icons/evia-512.png'];
