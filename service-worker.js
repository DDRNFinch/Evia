...
const F=['./manifest.webmanifest','./evia-release.json','./evia-approved-features.js','./evia-approved-learning-ui.js','./evia-approved-menu-support.js','./evia-approved-epa.js','./evia-approved-support-preview.js','./evia-approved-support-v1.js','./evia-approved-targets.js','./evia-approved-target-plan-v1.js','./evia-approved-updates.js','./evia-approved-smoke-fixes-v1.js','./evia-ui-polish-v1.js','./evia-ui-polish-visible-v1.js','./evia-approved-settings-icon-fix.js','./evia-approved-speech-landing-fix.js','./icons/evia-180.png','./icons/evia-192.png','./icons/evia-512.png'];
...
function injectFeatures(html){
  ...
  if(!html.includes('evia-approved-smoke-fixes-v1.js'))tags.push('<script src="./evia-approved-smoke-fixes-v1.js"></script>');
  ...
  if(!html.includes('evia-approved-settings-icon-fix.js'))tags.push('<script src="./evia-approved-settings-icon-fix.js"></script>');
