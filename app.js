...
function supportingCardIcon(type){return ""}
async function openSupportingEvidence(){
 const base={course};
 $("#page-title").textContent="Supporting Evidence";
 $("#screen").innerHTML='<button class="secondary" id="back-supporting-course" type="button">‹ Back to course</button><div class="card"><div class="section-title">PORTFOLIO</div><h2>Supporting Evidence</h2><p>Anything else you want to keep as evidence for this course.</p></div><div class="supporting-list"><button type="button" class="card supporting-type" data-supporting-type="photo"><span class="supporting-type-copy"><strong>Photo</strong><small>Take or choose a photo</small></span><span class="supporting-type-arrow">›</span></button><button type="button" class="card supporting-type" data-supporting-type="video"><span class="supporting-type-copy"><strong>Video</strong><small>Record the job on video</small></span><span class="supporting-type-arrow">›</span></button><button type="button" class="card supporting-type" data-supporting-type="audio"><span class="supporting-type-copy"><strong>Audio</strong><small>Record a voice note</small></span><span class="supporting-type-arrow">›</span></button><button type="button" class="card supporting-type" data-supporting-type="document"><span class="supporting-type-copy"><strong>Files</strong><small>Choose a file from your device</small></span><span class="supporting-type-arrow">›</span></button></div>';
