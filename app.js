...
["Mixing mortar",["S14|Gauge and hand mix mortar to ratio.","K20|Mixing Mortar: Ratios, silos, pre-mixed, gauging, hand mixing and mechanical mixing.","S1|Comply with health and safety regulations, standards, and guidance.","K1|signage, Safety signage.","S6|Estimate and select required resources: For example, the quantity of bricks and blocks, mortar, wall ties and insulation.","K12|Simple resource estimation techniques: Quantity of bricks and blocks, amount of mortar, quantity of wall ties, DPCs, cavity trays and lintels.","K11|Basic principles of digital design and modelling systems.","B1|Put health, safety and wellbeing first."]],
...
["Repair brick walling",["S16|Carry out a simple repair: For example, replacing damaged bricks.","K24|Defects and repair: Construction defects and repair methods.","S1|Comply with health and safety regulations, standards, and guidance.","K1|Asbestos awareness.","S7|Prepare and maintain a safe working area.","K3|Safe systems of work: Site inductions, toolbox talks, risk assessments, method statements and hazard identification in the work area.","S20|Applies team working principles to their own and the wider build team.","B2|Consider the environment when using resources and carrying out processes."]],
