...
const SUBJECTS=new Set(['trade','maths','english','edi','epa']);
...
function subjectGuidance(subject){
  ...
  return 'Teach or test workplace equality, diversity and inclusion using respectful, practical UK workplace scenarios. Focus on fair treatment, inclusive behaviour, challenging assumptions and appropriate workplace action.'
}
...
function filterMappings(values,course,subject){
  ...
  if(subject!=='trade'&&subject!=='epa')return[];
