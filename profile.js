...
(function(){
  ...
  function initReadAloud(){
    ...
    const style=document.createElement("style");
    style.textContent=".evia-read-aloud-active{outline:2px solid var(--yellow)!important;outline-offset:4px}.evia-read-aloud-active:before{content:\"READING ALOUD\";display:block;font-size:9px;letter-spacing:.12em;font-weight:800;color:var(--yellow-ink);margin-bottom:7px}";
    document.head.appendChild(style);
  }
