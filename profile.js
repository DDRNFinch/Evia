...
(function(){
  ...
  function initEviaProfile(){
    ...
    style.textContent=`
      ...
      html.evia-dyslexia-font #app,html.evia-dyslexia-font #modal-root,html.evia-dyslexia-font #welcome-screen{font-family:"Trebuchet MS",Verdana,sans-serif!important}html.evia-dyslexia-font #app *,html.evia-dyslexia-font #modal-root *,html.evia-dyslexia-font #welcome-screen *{font-family:"Trebuchet MS",Verdana,sans-serif!important}html.evia-letter-spacing #app *:not(svg),html.evia-letter-spacing #modal-root *:not(svg),html.evia-letter-spacing #welcome-screen *:not(svg){letter-spacing:.045em!important}html.evia-line-spacing #app p,html.evia-line-spacing #app li,html.evia-line-spacing #app h1,html.evia-line-spacing #app h2,html.evia-line-spacing #app h3,html.evia-line-spacing #modal-root p,html.evia-line-spacing #modal-root li,html.evia-line-spacing #modal-root h1,html.evia-line-spacing #modal-root h2,html.evia-line-spacing #modal-root h3,html.evia-line-spacing #welcome-screen p,html.evia-line-spacing #welcome-screen h1,html.evia-line-spacing #welcome-screen h2,html.evia-line-spacing #welcome-screen h3{line-height:1.75!important}html.evia-high-contrast #app,html.evia-high-contrast #modal-root,html.evia-high-contrast #welcome-screen{color:#000!important}html.evia-high-contrast #app p,html.evia-high-contrast #modal-root p,html.evia-high-contrast #welcome-screen p{color:#111!important}html.evia-high-contrast #app button,html.evia-high-contrast #modal-root button{border-color:#111!important}html.evia-reading-guide:after{content:"";position:fixed;left:0;right:0;top:var(--evia-reading-guide-position,48%);height:42px;transform:translateY(-50%);background:var(--evia-reading-guide-background,rgba(255,220,0,.16));border-top:1px solid rgba(0,0,0,.18);border-bottom:1px solid rgba(0,0,0,.18);pointer-events:none;z-index:9998}html.evia-focus-mode #app .card,html.evia-focus-mode #app .unit-card,html.evia-focus-mode #app .guidance{box-shadow:none!important}html.evia-focus-mode #app .bottom-nav,html.evia-focus-mode #app .evia-fab{opacity:.35}html.evia-focus-mode #app .screen>*{transition:opacity .2s ease}html[data-evia-overlay="cream"] #app,html[data-evia-overlay="cream"] #modal-root,html[data-evia-overlay="cream"] #welcome-screen{background:#fff7df!important}html[data-evia-overlay="soft-yellow"] #app,html[data-evia-overlay="soft-yellow"] #modal-root,html[data-evia-overlay="soft-yellow"] #welcome-screen{background:#fffbe8!important}html[data-evia-overlay="soft-blue"] #app,html[data-evia-overlay="soft-blue"] #modal-root,html[data-evia-overlay="soft-blue"] #welcome-screen{background:#edf6ff!important}html[data-evia-overlay="soft-pink"] #app,html[data-evia-overlay="soft-pink"] #modal-root,html[data-evia-overlay="soft-pink"] #welcome-screen{background:#fff0f5!important}html.evia-text-scale-115 #app,html.evia-text-scale-115 #modal-root,html.evia-text-scale-115 #welcome-screen{font-size:115%}html.evia-text-scale-130 #app,html.evia-text-scale-130 #modal-root,html.evia-text-scale-130 #welcome-screen{font-size:130%}html.evia-text-scale-150 #app,html.evia-text-scale-150 #modal-root,html.evia-text-scale-150 #welcome-screen{font-size:150%}      .welcome-avatar{cursor:pointer}.welcome-avatar .evia-face{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:10px}.welcome-avatar .evia-face i{display:block;flex:0 0 30px;width:30px;height:38px;border:4.5px solid var(--yellow);border-radius:50%;position:relative;transform-origin:center}.welcome-avatar .evia-face i:after{display:none}.welcome-avatar .evia-face i:first-child{animation:eyeLookA 7s ease-in-out infinite}.welcome-avatar .evia-face i:nth-child(2){animation:eyeLookB 7s ease-in-out infinite}
