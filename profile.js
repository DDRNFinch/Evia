...
(function(){
  ...
  function finishWelcome(){
    ...
    screenEl.classList.add("welcome-main-hidden");
    root.classList.add("leaving");
    requestAnimationFrame(()=>screenEl.classList.add("welcome-main-visible"));
