...
(function(){
  ...
  function openSettings(){
    ...
    const openSetting=(key)=>{
      ...
      else if(key==="readingGuide")controls='<label class="guide-position-control"><span>Transparency</span><input id="guide-position" type="range" min="0" max="100" value="42"><output id="guide-position-value">42%</output></label><div class="guide-colour-options">'+[["clear","Clear"],["yellow","Yellow"],["blue","Blue"],["pink","Pink"]].map(o=>'<button type="button" data-choice="'+o[0]+'" class="'+(o[0]==="yellow"?"selected":"")+'"><i></i>'+o[1]+'</button>').join("")+'</div><div class="setting-toggle-row"><span><strong>Reading guide</strong><small>Turn the reading guide on or off.</small></span><label class="setting-switch"><input id="setting-enabled" type="checkbox" checked><i></i><em>On</em></label></div>';
  ...
  function initEviaProfile(){
    ...
    style.textContent=`
      ...
      html.evia-dyslexia-font #app,html.evia-dyslexia-font #modal-root,html.evia-dyslexia-font #welcome-screen{font-family:"Trebuchet MS",Verdana,Arial,sans-serif!important}
      html.evia-dyslexia-font #app *,html.evia-dyslexia-font #modal-root *,html.evia-dyslexia-font #welcome-screen *{font-family:"Trebuchet MS",Verdana,Arial,sans-serif!important}
      html.evia-letter-spacing #app *,html.evia-letter-spacing #modal-root *,html.evia-letter-spacing #welcome-screen *{letter-spacing:.10em!important}
      html.evia-line-spacing #app p,html.evia-line-spacing #app li,html.evia-line-spacing #app h1,html.evia-line-spacing #app h2,html.evia-line-spacing #app h3,html.evia-line-spacing #app label,html.evia-letter-spacing #app span,html.evia-line-spacing #modal-root p,html.evia-line-spacing #modal-root li,html.evia-line-spacing #modal-root h1,html.evia-line-spacing #modal-root h2,html.evia-line-spacing #modal-root h3,html.evia-line-spacing #modal-root label,html.evia-line-spacing #welcome-screen p,html.evia-line-spacing #welcome-screen h1,html.evia-line-spacing #welcome-screen h2,html.evia-line-spacing #welcome-screen h3{line-height:1.9!important}
      html.evia-high-contrast #app,html.evia-high-contrast #modal-root,html.evia-high-contrast #welcome-screen{background:#000!important;color:#fff!important}
      html.evia-high-contrast #app *,html.evia-high-contrast #modal-root *,html.evia-high-contrast #welcome-screen *{color:#fff!important;border-color:#fff!important}
      html.evia-high-contrast #app button,html.evia-high-contrast #modal-root button{background:#000!important;color:#fff!important;border:2px solid #fff!important}
      html.evia-high-contrast #app input,html.evia-high-contrast #app textarea,html.evia-high-contrast #modal-root input,html.evia-high-contrast #modal-root textarea{background:#000!important;color:#fff!important;border:2px solid #fff!important}
      html.evia-reading-guide:after{display:none!important}
      ...
      html.evia-focus-mode #app .bottom-nav,html.evia-focus-mode #app .evia-fab{opacity:.12!important}
      html.evia-focus-mode #app .screen{max-width:600px!important}
      html.evia-focus-mode #app .screen>*{opacity:.42!important;filter:saturate(.35) blur(.15px)!important;transition:opacity .18s ease,filter .18s ease!important}
      html.evia-focus-mode #app .screen>*:focus-within,html.evia-focus-mode #app .screen>*:hover{opacity:1!important;filter:none!important}
      ...
      html.evia-text-scale-115 #app{zoom:1.15}html.evia-text-scale-130 #app{zoom:1.3}html.evia-text-scale-150 #app{zoom:1.5}
      html.evia-text-scale-115 #modal-root,html.evia-text-scale-115 #welcome-screen{zoom:1.15}html.evia-text-scale-130 #modal-root,html.evia-text-scale-130 #welcome-screen{zoom:1.3}html.evia-text-scale-150 #modal-root,html.evia-text-scale-150 #welcome-screen{zoom:1.5}      .welcome-avatar{cursor:pointer}.welcome-avatar .evia-face{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;gap:10px}.welcome-avatar .evia-face i{display:block;flex:0 0 30px;width:30px;height:38px;border:4.5px solid var(--yellow);border-radius:50%;position:relative;transform-origin:center}.welcome-avatar .evia-face i:after{display:none}.welcome-avatar .evia-face i:first-child{animation:eyeLookA 7s ease-in-out infinite}.welcome-avatar .evia-face i:nth-child(2){animation:eyeLookB 7s ease-in-out infinite}
